...
module NMK112(
  input         clock,
  input         reset,
  input         io_page_table_0,
  input         io_page_six_bit,
  input         io_cpu_wr,
  ...
  wire [5:0] cpu_page = io_page_six_bit ? io_cpu_din[5:0] : {1'b0, io_cpu_din[4:0]};
  ...
  wire [1:0] chip_0_bank = (io_page_table_0 & (io_addr_0_in < 25'h00400)) ? io_addr_0_in[9:8]
                                                                          : io_addr_0_in[17:16];
  wire [1:0] chip_1_bank = (io_addr_1_in > 25'h00400) ? io_addr_1_in[17:16]
                                                       : io_addr_1_in[9:8];
  wire [5:0] chip_0_page = select_page(chip_0_bank, page_0_0, page_0_1, page_0_2, page_0_3);
  wire [5:0] chip_1_page = select_page(chip_1_bank, page_1_0, page_1_1, page_1_2, page_1_3);
