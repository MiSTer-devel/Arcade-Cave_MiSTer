  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        offsetReg = _RANDOM[3'h0][5:3];
        requestReg_rd = _RANDOM[3'h0][6];
        requestReg_addr_tag = _RANDOM[3'h0][27:7];
        requestReg_addr_index = _RANDOM[3'h0][29:28];
        requestReg_addr_offset = _RANDOM[3'h0][31:30];
        doutReg = _RANDOM[3'h1][7:0];
        validReg = _RANDOM[3'h1][8];
        lruReg = _RANDOM[3'h1][12:9];
        wayReg = _RANDOM[3'h1][13];
        cacheEntryReg_valid = _RANDOM[3'h1][14];
        cacheEntryReg_dirty = _RANDOM[3'h1][15];
        cacheEntryReg_tag = {_RANDOM[3'h1][31:16], _RANDOM[3'h2][4:0]};
        cacheEntryReg_line_words_0 = _RANDOM[3'h2][20:5];
        cacheEntryReg_line_words_1 = {_RANDOM[3'h2][31:21], _RANDOM[3'h3][4:0]};
        cacheEntryReg_line_words_2 = _RANDOM[3'h3][20:5];
        cacheEntryReg_line_words_3 = {_RANDOM[3'h3][31:21], _RANDOM[3'h4][4:0]};
        initCounter = _RANDOM[3'h4][6:5];
        burstCounter = _RANDOM[3'h4][8:7];
      `endif // RANDOMIZE_REG_INIT
    end // initial
