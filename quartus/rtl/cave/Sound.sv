  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        reqReg = _RANDOM[2'h0][0];
        dataReg = _RANDOM[2'h0][16:1];
        z80BankReg = _RANDOM[2'h0][20:17];
        okiBankHiReg = _RANDOM[2'h0][24:21];
        okiBankLoReg = _RANDOM[2'h0][28:25];
        io_audio_r = {_RANDOM[2'h0][31:29], _RANDOM[2'h1][12:0]};
        io_audio_r_1 = _RANDOM[2'h1][28:13];
        io_audio_r_2 = {_RANDOM[2'h1][31:29], _RANDOM[2'h2][12:0]};
        io_audio_r_3 = _RANDOM[2'h2][26:13];
        io_audio_r_4 = {_RANDOM[2'h2][31:27], _RANDOM[2'h3][8:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
