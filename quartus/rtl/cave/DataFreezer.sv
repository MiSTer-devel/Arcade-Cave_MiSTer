  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        data_dataReg = _RANDOM[/*Zero width*/ 1'b0][19:4];
        data_enableReg = _RANDOM[/*Zero width*/ 1'b0][20];
        pendingRead = _RANDOM[/*Zero width*/ 1'b0][21];
        pendingWrite = _RANDOM[/*Zero width*/ 1'b0][22];
        clearRead_REG = _RANDOM[/*Zero width*/ 1'b0][23];
      `endif // RANDOMIZE_REG_INIT
    end // initial
