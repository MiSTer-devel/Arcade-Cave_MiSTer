  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stateReg = _RANDOM[4'h0][2:0];
        offsetReg = _RANDOM[4'h0][4:3];
        requestReg_rd = _RANDOM[4'h0][5];
        requestReg_addr_tag = _RANDOM[4'h0][16:6];
        requestReg_addr_index = _RANDOM[4'h0][23:17];
        requestReg_addr_offset = _RANDOM[4'h0][25:24];
        doutReg = {_RANDOM[4'h0][31:26], _RANDOM[4'h1][9:0]};
        validReg = _RANDOM[4'h1][10];
        lruReg =
          {_RANDOM[4'h1][31:11],
           _RANDOM[4'h2],
           _RANDOM[4'h3],
           _RANDOM[4'h4],
           _RANDOM[4'h5][10:0]};
        wayReg = _RANDOM[4'h5][11];
        cacheEntryReg_valid = _RANDOM[4'h5][12];
        cacheEntryReg_dirty = _RANDOM[4'h5][13];
        cacheEntryReg_tag = _RANDOM[4'h5][24:14];
        cacheEntryReg_line_words_0 = {_RANDOM[4'h5][31:25], _RANDOM[4'h6][8:0]};
        cacheEntryReg_line_words_1 = _RANDOM[4'h6][24:9];
        cacheEntryReg_line_words_2 = {_RANDOM[4'h6][31:25], _RANDOM[4'h7][8:0]};
        cacheEntryReg_line_words_3 = _RANDOM[4'h7][24:9];
        initCounter = _RANDOM[4'h7][31:25];
        burstCounter = _RANDOM[4'h8][1:0];
      `endif // RANDOMIZE_REG_INIT
    end // initial
