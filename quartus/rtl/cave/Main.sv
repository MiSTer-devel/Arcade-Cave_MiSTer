  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vBlank_r = _RANDOM[5'h0][0];
        vBlank = _RANDOM[5'h0][1];
        vBlankRising_REG = _RANDOM[5'h0][2];
        pauseReg_REG = _RANDOM[5'h0][3];
        pauseReg = _RANDOM[5'h0][4];
        videoIrq = _RANDOM[5'h0][5];
        agalletIrq = _RANDOM[5'h0][6];
        unknownIrq = _RANDOM[5'h0][7];
        dinReg = _RANDOM[5'h0][23:8];
        dtackReg = _RANDOM[5'h0][24];
        readStrobe_REG = _RANDOM[5'h0][25];
        upperWriteStrobe_REG = _RANDOM[5'h0][26];
        lowerWriteStrobe_REG = _RANDOM[5'h0][27];
        eeprom_io_serial_cs_r = _RANDOM[5'h0][28];
        eeprom_io_serial_sck_r = _RANDOM[5'h0][29];
        eeprom_io_serial_sdi_r = _RANDOM[5'h0][30];
        io_gpuMem_layer_0_regs_r_tileSize = _RANDOM[5'h1][1];
        io_gpuMem_layer_0_regs_r_enable = _RANDOM[5'h1][2];
        io_gpuMem_layer_0_regs_r_flipX = _RANDOM[5'h1][3];
        io_gpuMem_layer_0_regs_r_flipY = _RANDOM[5'h1][4];
        io_gpuMem_layer_0_regs_r_rowScrollEnable = _RANDOM[5'h1][5];
        io_gpuMem_layer_0_regs_r_rowSelectEnable = _RANDOM[5'h1][6];
        io_gpuMem_layer_0_regs_r_scroll_x = _RANDOM[5'h1][15:7];
        io_gpuMem_layer_0_regs_r_scroll_y = _RANDOM[5'h1][24:16];
        io_gpuMem_layer_0_regs_r_1_tileSize = _RANDOM[5'h1][27];
        io_gpuMem_layer_0_regs_r_1_enable = _RANDOM[5'h1][28];
        io_gpuMem_layer_0_regs_r_1_flipX = _RANDOM[5'h1][29];
        io_gpuMem_layer_0_regs_r_1_flipY = _RANDOM[5'h1][30];
        io_gpuMem_layer_0_regs_r_1_rowScrollEnable = _RANDOM[5'h1][31];
        io_gpuMem_layer_0_regs_r_1_rowSelectEnable = _RANDOM[5'h2][0];
        io_gpuMem_layer_0_regs_r_1_scroll_x = _RANDOM[5'h2][9:1];
        io_gpuMem_layer_0_regs_r_1_scroll_y = _RANDOM[5'h2][18:10];
        io_gpuMem_layer_1_regs_r_tileSize = _RANDOM[5'h2][21];
        io_gpuMem_layer_1_regs_r_enable = _RANDOM[5'h2][22];
        io_gpuMem_layer_1_regs_r_flipX = _RANDOM[5'h2][23];
        io_gpuMem_layer_1_regs_r_flipY = _RANDOM[5'h2][24];
        io_gpuMem_layer_1_regs_r_rowScrollEnable = _RANDOM[5'h2][25];
        io_gpuMem_layer_1_regs_r_rowSelectEnable = _RANDOM[5'h2][26];
        io_gpuMem_layer_1_regs_r_scroll_x = {_RANDOM[5'h2][31:27], _RANDOM[5'h3][3:0]};
        io_gpuMem_layer_1_regs_r_scroll_y = _RANDOM[5'h3][12:4];
        io_gpuMem_layer_1_regs_r_1_tileSize = _RANDOM[5'h3][15];
        io_gpuMem_layer_1_regs_r_1_enable = _RANDOM[5'h3][16];
        io_gpuMem_layer_1_regs_r_1_flipX = _RANDOM[5'h3][17];
        io_gpuMem_layer_1_regs_r_1_flipY = _RANDOM[5'h3][18];
        io_gpuMem_layer_1_regs_r_1_rowScrollEnable = _RANDOM[5'h3][19];
        io_gpuMem_layer_1_regs_r_1_rowSelectEnable = _RANDOM[5'h3][20];
        io_gpuMem_layer_1_regs_r_1_scroll_x = _RANDOM[5'h3][29:21];
        io_gpuMem_layer_1_regs_r_1_scroll_y = {_RANDOM[5'h3][31:30], _RANDOM[5'h4][6:0]};
        io_gpuMem_layer_2_regs_r_tileSize = _RANDOM[5'h4][9];
        io_gpuMem_layer_2_regs_r_enable = _RANDOM[5'h4][10];
        io_gpuMem_layer_2_regs_r_flipX = _RANDOM[5'h4][11];
        io_gpuMem_layer_2_regs_r_flipY = _RANDOM[5'h4][12];
        io_gpuMem_layer_2_regs_r_rowScrollEnable = _RANDOM[5'h4][13];
        io_gpuMem_layer_2_regs_r_rowSelectEnable = _RANDOM[5'h4][14];
        io_gpuMem_layer_2_regs_r_scroll_x = _RANDOM[5'h4][23:15];
        io_gpuMem_layer_2_regs_r_scroll_y = {_RANDOM[5'h4][31:24], _RANDOM[5'h5][0]};
        io_gpuMem_layer_2_regs_r_1_tileSize = _RANDOM[5'h5][3];
        io_gpuMem_layer_2_regs_r_1_enable = _RANDOM[5'h5][4];
        io_gpuMem_layer_2_regs_r_1_flipX = _RANDOM[5'h5][5];
        io_gpuMem_layer_2_regs_r_1_flipY = _RANDOM[5'h5][6];
        io_gpuMem_layer_2_regs_r_1_rowScrollEnable = _RANDOM[5'h5][7];
        io_gpuMem_layer_2_regs_r_1_rowSelectEnable = _RANDOM[5'h5][8];
        io_gpuMem_layer_2_regs_r_1_scroll_x = _RANDOM[5'h5][17:9];
        io_gpuMem_layer_2_regs_r_1_scroll_y = _RANDOM[5'h5][26:18];
        REG = _RANDOM[5'h5][27];
        coin1_pulseCounterWrap_value = {_RANDOM[5'h5][31:28], _RANDOM[5'h6][17:0]};
        coin1_s_REG = _RANDOM[5'h6][18];
        coin1_s_enableReg = _RANDOM[5'h6][19];
        coin2_pulseCounterWrap_value = {_RANDOM[5'h6][31:20], _RANDOM[5'h7][9:0]};
        coin2_s_REG = _RANDOM[5'h7][10];
        coin2_s_enableReg = _RANDOM[5'h7][11];
        service_pulseCounterWrap_value = {_RANDOM[5'h7][31:12], _RANDOM[5'h8][6:0]};
        service_s_REG = _RANDOM[5'h8][7];
        service_s_enableReg = _RANDOM[5'h8][8];
        tmp = _RANDOM[5'h8][24:9];
        tmp_1 = {_RANDOM[5'h8][31:25], _RANDOM[5'h9][8:0]};
        tmp_2 = _RANDOM[5'h9][24:9];
        tmp_3 = {_RANDOM[5'h9][31:25], _RANDOM[5'hA][8:0]};
        tmp_4 = _RANDOM[5'hA][24:9];
        tmp_5 = {_RANDOM[5'hA][31:25], _RANDOM[5'hB][8:0]};
        tmp_6 = _RANDOM[5'hB][24:9];
        tmp_7 = {_RANDOM[5'hB][31:25], _RANDOM[5'hC][8:0]};
        tmp_8 = _RANDOM[5'hC][24:9];
        tmp_9 = {_RANDOM[5'hC][31:25], _RANDOM[5'hD][8:0]};
        tmp_10 = _RANDOM[5'hD][24:9];
        tmp_11 = {_RANDOM[5'hD][31:25], _RANDOM[5'hE][8:0]};
        tmp_12 = _RANDOM[5'hE][24:9];
        tmp_13 = {_RANDOM[5'hE][31:25], _RANDOM[5'hF][8:0]};
        tmp_14 = _RANDOM[5'hF][24:9];
        tmp_15 = {_RANDOM[5'hF][31:25], _RANDOM[5'h10][8:0]};
        tmp_16 = _RANDOM[5'h10][24:9];
        tmp_17 = {_RANDOM[5'h10][31:25], _RANDOM[5'h11][8:0]};
        tmp_18 = _RANDOM[5'h11][24:9];
        tmp_19 = {_RANDOM[5'h11][31:25], _RANDOM[5'h12][8:0]};
        tmp_20 = _RANDOM[5'h12][24:9];
        tmp_21 = {_RANDOM[5'h12][31:25], _RANDOM[5'h13][8:0]};
        tmp_22 = _RANDOM[5'h13][24:9];
        tmp_23 = {_RANDOM[5'h13][31:25], _RANDOM[5'h14][8:0]};
        tmp_24 = _RANDOM[5'h14][24:9];
        tmp_25 = {_RANDOM[5'h14][31:25], _RANDOM[5'h15][8:0]};
        tmp_26 = _RANDOM[5'h15][24:9];
        tmp_27 = {_RANDOM[5'h15][31:25], _RANDOM[5'h16][8:0]};
        tmp_28 = _RANDOM[5'h16][24:9];
        tmp_29 = {_RANDOM[5'h16][31:25], _RANDOM[5'h17][8:0]};
        tmp_30 = _RANDOM[5'h17][24:9];
        tmp_31 = {_RANDOM[5'h17][31:25], _RANDOM[5'h18][8:0]};
        tmp_32 = _RANDOM[5'h18][24:9];
        tmp_33 = {_RANDOM[5'h18][31:25], _RANDOM[5'h19][8:0]};
        tmp_34 = _RANDOM[5'h19][24:9];
        tmp_35 = {_RANDOM[5'h19][31:25], _RANDOM[5'h1A][8:0]};
        tmp_36 = _RANDOM[5'h1A][24:9];
        tmp_37 = {_RANDOM[5'h1A][31:25], _RANDOM[5'h1B][8:0]};
      `endif // RANDOMIZE_REG_INIT
    end // initial
