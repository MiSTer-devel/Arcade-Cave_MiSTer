  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stateReg = _RANDOM[2'h0][3:0];
        offsetReg = _RANDOM[2'h0][5:4];
        requestReg_rd = _RANDOM[2'h0][6];
        requestReg_wr = _RANDOM[2'h0][7];
        requestReg_addr_tag = _RANDOM[2'h0][11:8];
        requestReg_addr_index = _RANDOM[2'h0][12];
        requestReg_addr_offset = _RANDOM[2'h0][14:13];
        requestReg_din = _RANDOM[2'h0][30:15];
        doutReg = _RANDOM[2'h1][16:1];
        validReg = _RANDOM[2'h1][17];
        lruReg = _RANDOM[2'h1][19:18];
        wayReg = _RANDOM[2'h1][20];
        cacheEntryReg_valid = _RANDOM[2'h1][21];
        cacheEntryReg_dirty = _RANDOM[2'h1][22];
        cacheEntryReg_tag = _RANDOM[2'h1][26:23];
        cacheEntryReg_line_words_0 = {_RANDOM[2'h1][31:27], _RANDOM[2'h2][10:0]};
        cacheEntryReg_line_words_1 = _RANDOM[2'h2][26:11];
        cacheEntryReg_line_words_2 = {_RANDOM[2'h2][31:27], _RANDOM[2'h3][10:0]};
        cacheEntryReg_line_words_3 = _RANDOM[2'h3][26:11];
        initCounter = _RANDOM[2'h3][27];
        burstCounter = _RANDOM[2'h3][29:28];
      `endif // RANDOMIZE_REG_INIT
    end // initial
