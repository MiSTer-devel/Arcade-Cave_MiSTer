  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        stateReg = _RANDOM[3'h0][3:0];
        accumulatorReg_left = _RANDOM[3'h0][20:4];
        channelCounter = _RANDOM[3'h1][8:6];
        outputCounterWrap_value = _RANDOM[3'h1][17:9];
        channelStateReg_enable = _RANDOM[3'h1][18];
        channelStateReg_active = _RANDOM[3'h1][19];
        channelStateReg_done = _RANDOM[3'h1][20];
        channelStateReg_nibble = _RANDOM[3'h1][21];
        channelStateReg_addr = {_RANDOM[3'h1][31:22], _RANDOM[3'h2][13:0]};
        channelStateReg_loopStart = _RANDOM[3'h2][14];
        channelStateReg_audioPipelineState_samples_0 = _RANDOM[3'h2][30:15];
        channelStateReg_audioPipelineState_samples_1 =
          {_RANDOM[3'h2][31], _RANDOM[3'h3][14:0]};
        channelStateReg_audioPipelineState_underflow = _RANDOM[3'h3][15];
        channelStateReg_audioPipelineState_adpcmStep = _RANDOM[3'h3][31:16];
        channelStateReg_audioPipelineState_lerpIndex = _RANDOM[3'h4][9:0];
        channelStateReg_audioPipelineState_loopEnable = _RANDOM[3'h4][10];
        channelStateReg_audioPipelineState_loopStep = _RANDOM[3'h4][26:11];
        channelStateReg_audioPipelineState_loopSample =
          {_RANDOM[3'h4][31:27], _RANDOM[3'h5][10:0]};
        pendingReg = _RANDOM[3'h5][11];
      `endif // RANDOMIZE_REG_INIT
    end // initial
