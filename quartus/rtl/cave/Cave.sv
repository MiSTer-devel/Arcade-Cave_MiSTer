  ...
  `ifdef ENABLE_INITIAL_REG_
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        vBlank_r = _RANDOM[/*Zero width*/ 1'b0][0];
        vBlank = _RANDOM[/*Zero width*/ 1'b0][1];
        vBlankFalling_REG = _RANDOM[/*Zero width*/ 1'b0][2];
        gameIndexReg = _RANDOM[/*Zero width*/ 1'b0][6:3];
        gameIndexReg_latched = _RANDOM[/*Zero width*/ 1'b0][7];
        gameIndexReg_REG = _RANDOM[/*Zero width*/ 1'b0][8];
        memSys_io_prog_nvram_view__ioctl_din_r = _RANDOM[/*Zero width*/ 1'b0][24:9];
        memSys_io_prog_done_REG = _RANDOM[/*Zero width*/ 1'b0][25];
        videoSys_io_prog_done_REG = _RANDOM[/*Zero width*/ 1'b0][26];
      `endif // RANDOMIZE_REG_INIT
    end // initial
